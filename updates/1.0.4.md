...
1. Added API lua file for the Developers with (3) default functions for adding ownership or removing ownership of ranches.
2. Added (2) new functions on `server/escrow_ignore.lua` file when purchasing a ranch or when ranch is lost for any reason.
